              ...
              <div className="p-4 md:p-5 flex-1 flex flex-col">
                ...
                <div className="flex items-center gap-3 mb-4 md:mb-5">
                  <div className="flex -space-x-2">
                    <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-tertiary flex items-center justify-center text-white text-xs font-medium border-2 border-card">A</div>
                    <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-tertiary flex items-center justify-center text-white text-xs font-medium border-2 border-card">B</div>
                  </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="card overflow-hidden shadow-lg flex-1 flex flex-col">
              ...
              <div className="p-4 md:p-5 flex-1 flex flex-col">
                ...
                <div className="flex items-center gap-3 mb-4 md:mb-5">
                  <div className="flex -space-x-2">
                    <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-accent flex items-center justify-center text-white text-xs font-medium border-2 border-card">A</div>
                    <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-[#f59e0b] flex items-center justify-center text-white text-xs font-medium border-2 border-card">B</div>
                  </div>
