...
export default function HeroV4Claude3() {
  const codeSnippets = [
      ...
      <div className="max-w-[980px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-[980px] mx-auto">
          ...
          <div className="card overflow-hidden shadow-lg">
            ...
            <div className="p-2">
              {/* Screen share layout: large shared screen + small camera feeds */}
              <div className="flex flex-col gap-1.5">
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  <div className="relative rounded-lg aspect-[16/10] bg-[#1e1e1e] flex items-center justify-center">
                    <svg className="w-6 h-6 text-[#3a3a3a]" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
                    </svg>
                    <div className="absolute bottom-1 left-1">
                      <span className="text-[7px] bg-black/50 text-white/70 px-1 py-0.5 rounded">You</span>
                    </div>
                  </div>
                  <div className="relative rounded-lg aspect-[16/10] bg-[#1e1e1e] flex items-center justify-center">
                    <svg className="w-6 h-6 text-[#3a3a3a]" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="absolute bottom-1 left-1">
                      <span className="text-[7px] bg-[#8b5cf6]/70 text-white px-1 py-0.5 rounded">Mentor</span>
                    </div>
                  </div>
                </div>
              </div>
