        ...
        <div className="max-w-[980px] mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-white/70 backdrop-blur-md border border-white/40 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.08)] p-8 md:p-12 text-left">
              ...
              <p className="text-lg text-text mb-6">
                It got so addictive that I stopped watching Netflix.<br />
                Shipping felt incredible.
              </p>
              <p className="text-lg text-text mb-6">
                But something felt off.
              </p>
              <p className="text-lg text-text mb-6">
                Every app worked — yet felt lonely.<br />
                Users showed up, clicked around, and left. No presence. No energy. No humans.
              </p>
              <p className="text-lg text-text mb-6">
                AI can write code.<br />
                But it can&apos;t create togetherness.
              </p>
              <p className="text-lg text-text mb-6">
                So I built VibeLive — invisible infrastructure that adds live video inside vibecoded apps.<br />
                No WebRTC. No servers. No friction. Just real people, present where your users already are.
              </p>
              <p className="text-lg text-text mb-6">
