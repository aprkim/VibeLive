...
export default function HeroV4Claude5() {
  const codeSnippets = [
  ...
  return (
    <section className="py-20 md:py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-[980px] mx-auto relative z-10">
        ...
        <div className="max-w-[580px] mx-auto mb-16 relative">
          {/* Spotlight glow behind prompt */}
          <div
            className="absolute -inset-12 rounded-3xl pointer-events-none hidden md:block"
            style={{ background: 'radial-gradient(ellipse at center, rgba(14,165,164,0.06) 0%, transparent 70%)' }}
          />
          <p className="text-sm text-muted/60 text-center mb-3 relative">
            Start by pasting this into your AI coding assistant.
          </p>
          <div className="rounded-xl overflow-hidden border border-accent/20 bg-[#0a0a0a] shadow-2xl shadow-black/60 relative group ring-1 ring-accent/[0.08]">
            {/* Copy button */}
            <button
              onClick={() => {
                ...
                if (btn) {
                  btn.innerHTML = 'Copied <span style="opacity:0.7">✓</span>';
                  setTimeout(() => { btn.textContent = 'Copy'; }, 2000);
                }
              }}
              id="copy-btn"
              className="absolute top-4 right-4 text-[11px] font-mono text-accent/70 hover:text-accent bg-accent/10 hover:bg-accent/20 border border-accent/20 hover:border-accent/30 rounded-md px-3 py-1.5 transition-all z-10"
            >
              Copy
            </button>
            <div className="px-6 py-5 pr-20">
              <div className="flex items-start gap-3">
                <span className="text-accent text-sm mt-[2px] select-none shrink-0 font-mono font-bold" style={{ textShadow: '0 0 10px rgba(14,165,164,0.5)' }}>❯</span>
                <p className="text-[14px] text-[#d4d4d4] leading-[1.7] font-mono">
                  ...
                  <br />
                  <span className="text-[#5b9fc7]/70 text-[13px]">https://vibelive.site/start/try?key=guest-teal-14d</span>
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Three Live Video Cards (room samples) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-[980px] mx-auto mt-4">
          ...
          <div className="card overflow-hidden shadow-lg">
            ...
            <div className="p-2">
              {/* Screen share with PiP camera feeds overlaid */}
              <div className="relative rounded-lg aspect-[16/10] bg-[#141414] flex items-center justify-center border border-[#2a2a2a]">
                ...
                {/* PiP cameras — stacked bottom-right */}
