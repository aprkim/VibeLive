# VibeLive Integration Guide v2

**MiniChat API Guide v0.64 + Design Guide v2.3**
...
- **API Guide** (this document) defines system behavior and lifecycle semantics
- **Design Guide** ([design_guide_v2.3.md](design_guide_v2.3.md)) defines visual presentation and interaction rules
...
Version 0.64 | February 20, 2026

> **Note:** Code examples in this section have been updated to comply with the Design Guide's visual rules (inline SVG icons instead of emoji, "Your Screen" label for local screenshare, LIVE badge on screenshare tiles). The Complete Minimal Example is intentionally simplified and omits these — refer to the detailed `createVideoTile()` pattern and the [Design Guide](design_guide_v2.3.md) for full visual requirements. See [CONFLICTS.md](CONFLICTS.md) for the full list.
...
See also: [Design Guide](design_guide_v2.3.md) §Shareable Invite Link and §URL Deep Linking.
...
- **Icons:** Use inline SVG icons for camera and microphone indicators — no emoji (see [Design Guide](design_guide_v2.3.md) §Core Design Philosophy and §Media Indicators)
- **Screenshare labels:** Local user sees "Your Screen"; remote users see "Name's Screen" (see [Design Guide](design_guide_v2.3.md) §Screen Share Tile Semantics)
- **Screenshare LIVE badge:** Screenshare tiles include a LIVE badge matching the styling of camera tiles (see [Design Guide](design_guide_v2.3.md) §Screen Share Tile Semantics)
...
| `startLive()` | Connect WebRTC → LIVE (does NOT start audio/video) |
...
*MiniChat API v1.0 — Facade over MiniChatCore.*

---

> **Design Guide:** For all visual, interaction, and layout rules, see the separate [design_guide_v2.3.md](design_guide_v2.3.md).

---

*VibeLive Integration Guide v2 — MiniChat API v0.64 + Design Guide v2.3 | Last updated: 2026-02-22*
